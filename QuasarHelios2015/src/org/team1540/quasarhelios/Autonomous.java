...
public class Autonomous {
	public static InstinctMultiModule mainModule = new InstinctMultiModule(
			ControlInterface.autoTuning);
	...
	public static void setup() {
		...
		mainModule.loadSettings(mainModule.addNullMode("none",
				"I'm a sitting chicken!"));
