...
public class Rollers {
	private static final BooleanStatus direction = new BooleanStatus(true);
	private static final BooleanStatus running = new BooleanStatus(false);
	...
	public static final FloatOutput allRollers = FloatMixing.combine(externalRollers, internalRollers);
