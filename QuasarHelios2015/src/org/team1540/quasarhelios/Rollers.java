...
public class Rollers {
    ...
    public static final BooleanStatus open = new BooleanStatus(BooleanMixing.combine(Igneous.makeSolenoid(1), Igneous.makeSolenoid(2)));
    ...
    public static void setup() {
        FloatMixing.pumpWhen(QuasarHelios.globalControl, motorSpeed, allRollers);
